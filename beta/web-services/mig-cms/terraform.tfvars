...
list_of_instance_template = [
  {
    region      = "asia-south1"
    name_prefix = "gce-it-beta-cms-as1"
    ...
    service_account = {
      email  = "sa-gce-forbes-beta-cms-as1@prj-beta-svc-forbes89.iam.gserviceaccount.com"
    ...
    hostname   = "gce-forbes-beta-as1-cms"
    mig_name   = "beta-forbes-as1-cms-mig"
    region     = "asia-south1"
    project_id = "prj-beta-svc-forbes89"                                                                    //service project id
    network    = "projects/prj-prod-host-forbes89/global/networks/vpc-prod-shared-host-forbes"               //host project vpc
    subnetwork = "projects/prj-prod-host-forbes89/regions/asia-south1/subnetworks/sb-beta-as1-forbes-app" //host project subnet 
    #Autoscaling policy
    autoscaler_name     = "autoscale-beta-forbes-cms-mig"
    ...
    # ports              = ["80"]
    health_check_name = "hc-beta-forbes-cms"
    health_check = {
      type                = "tcp"
